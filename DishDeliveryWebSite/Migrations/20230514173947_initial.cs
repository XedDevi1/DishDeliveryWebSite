        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", maxLength: 32767, nullable: true),
                    Surname = table.Column<string>(type: "nvarchar(max)", maxLength: 32767, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", maxLength: 32767, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    DishList = table.Column<string>(type: "nvarchar(max)", maxLength: 32767, nullable: true),
